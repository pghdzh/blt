...
const lines = [
  "扬起船帆，点燃焰火！愿为你领航全新的冒险之旅！",
  "启航时刻将至，你准备好迎接这场风暴般的挑战了吗？",
  "舞台已备好，灯光已就位。这场为你而演的戏，即将开幕！",
  "生活皆舞台，狂欢即世界！欢迎你的登场，我亲爱的‘愚人’伙伴！",
  "若是逆境接踵而至，便意味着我们的高光时刻，就要来了！",
  "别被规则束缚，戴上你的面具，与我一同纵情欢歌吧！",
] as const;
  ...
  .intro-inner {
    ...
    .typewriter-wrap {
      ...
      .typewriter {
        ...
        background: linear-gradient(90deg, #923257 0%, #70a7bb 100%);
