<template>
  <main class="home">
    ...
    <section class="center" role="main">
      <h1 class="title">被世界遗忘，唯你铭记的独一 · 尤诺</h1>
    ...
    >
      <div class="inner container">
        <div class="center">
          <div class="slogan">被抹去的存在，因你而重获意义</div>
          <div class="meta">
            © <span>{{ year }}</span> 尤诺电子设定集 · 制作：霜落天亦
          </div>
        </div>
      </div>
    </footer>
...
// ========== 打字机文案 ==========
// 适合尤诺风格的副标题（偏长句，已为打字器准备）
const lines = [
  "月光流照命途可窥，静滞时空中等待你的选择",
  "被世界遗忘的天才谕女，唯你铭记她存在的痕迹",
  "以存在为契改写既定终局，月光见证不灭的约定",
  "七丘的月光谕女静候归期，在记忆残响中与你重逢",
  "窥见万千未来的轨迹，却只为等待你这一次回眸",
  "时间回环中的温柔决绝，月光独语诉说着不朽诗篇",
  "黑潮将至的命定时刻，唯你是我唯一的命运变量",
  "静滞时空流淌月光低语，被遗忘的故事等你唤醒",
  "月光为证此约永不湮灭，跨越遗忘的永恒羁绊",
  "命途交织的回环之中，你是唯一的真实与变数",
  "七丘之上月光依旧流淌，等待命定之人的归来",
  "在记忆的缝隙间寻觅，那段被世界遗忘的相遇",
  "月光下的独一谕女，静候着改写命运的邂逅",
  "被抹去的存在痕迹，只在你的记忆中熠熠生辉",
  "静滞时空中的温柔守望，月光为约不负归期",
];
